...
export default function ExamAdminPage() {
  ...
  const loadUsers = async () => {
    ...
    const res = await axios.get("/admin/users?role=EXAM_ADMIN");
  ...
  return (
    <div className="p-5 space-y-6">
      <h2 className="text-xl font-bold">Exam Administrators</h2>

      <button
        onClick={() => navigate("/admin/create?role=EXAM_ADMIN")}
        className="my-2 bg-blue-600 text-white px-4 py-2 rounded"
      >
        + Create Exam Administrator
      </button>
